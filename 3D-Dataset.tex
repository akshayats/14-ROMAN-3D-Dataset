...
\begin{figure}
\begin{center}
\subfloat[][]{\label{fig:scatter-monitor-keybard}\includegraphics[width=0.8\linewidth]{monitor_keyboard-crop}}\quad
\subfloat[][]{\label{fig:scatter-keyboard-mug}\includegraphics[width=0.8\linewidth]{keyboard_mug-crop}}\\
\subfloat[][]{\label{fig:scater-keyboard-papers}\includegraphics[width=0.8\linewidth]{keyboard_papers-crop}}
\end{center}
\label{fig:scatter-rest}
\caption{The figures show the relative position of a) keyboard w.r.t. monitor, b) mug w.r.t. keyboard and c) papers w.r.t. keyboard. Qualitatively keyboards are mostly infront of monitors, mugs are around the keyboard and the position of papers is mosty independent on the position of the keyboard.} 
\end{figure}
