...
security guard in an office building. The robot patrols the working environment and should learn the allowed variations of different parts of space. In this work we focus on desktops the robot must look at table-tops of the office inhabitants and learn 
