...
\author{Akshaya Thippur$^{1}$, Rares Ambrus$^{1}$, Kaushik Desai$^{1}$, Adria Gallart$^{1}$, Malepati Sai Akhil$^{3}$, Gaurav Agrawal$^{3}$,\\Mayank Jha$^{3}$, Janardhan HR$^{3}$, Nishan Shetty$^{3}$, Prasad NR$^{3}$, John Folkesson $^{1}$ and Patric Jensfelt$^{1}$% <-this % stops a space
